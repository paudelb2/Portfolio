...
import MalwareResearch from '../assets/malwareresearch.pdf';
import MalwarePic from '../assets/malwarepic.png';
...
{/* Container */}
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
            ...
            {/* Grid Item */}
            <div
            style={{ backgroundImage: `url(${MalwarePic})` }}
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100'>
              ...
              <div className='pt-8 text-center'>
                <a href={MalwareResearch} target='_blank' alt= 'MalwareResearch'>
